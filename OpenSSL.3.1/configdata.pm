...
our %config = (
    ...
    "openssldir" => "D:\\Sources\\OpenSSL.3.1\\Release\\",
    "options" => "--release --prefix=D:\\Sources\\OpenSSL.3.1\\Release\\ --openssldir=D:\\Sources\\OpenSSL.3.1\\Release\\ --libdir=..\\Release no-acvp-tests no-afalgeng no-asan no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "0",
    "perl_archname" => "MSWin32-x86-multi-thread-64int",
    "perl_cmd" => "C:\\Perl\\bin\\perl.exe",
    "perl_version" => "5.24.2",
    "perlargv" => [
        "--release",
        "--prefix=D:\\Sources\\OpenSSL.3.1\\Release\\",
        "--openssldir=D:\\Sources\\OpenSSL.3.1\\Release\\",
        "--libdir=..\\Release",
        "no-shared",
        "no-capieng",
...
unless (caller) {
    ...
    use lib 'D:/Sources/OpenSSL.3.1/util/perl';
    use OpenSSL::fallback 'D:/Sources/OpenSSL.3.1/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/Sources/OpenSSL.3.1/Configurations';
        use gentemplate;
